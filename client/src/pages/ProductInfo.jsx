...
const ProductInfo = () => {
  ...
  const handleSubmit = async (id) => {
    if (
      productStates[id].quantity < 0 ||
      productStates[id].price < 0 ||
      productStates[id].discount < 0
    ) {
        ...
        <aside className="fixed inset-y-0 left-0 z-10 hidden w-14 flex-col border-r bg-background sm:flex">
          <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div
                  className="flex h-9 w-9 items-center justify-center rounded-lg bg-accent text-accent-foreground transition-colors hover:text-foreground md:h-8 md:w-8 cursor-pointer"
                >
            ...
            <Sheet>
              ...
              <SheetContent side="left" className="sm:max-w-xs">
                <nav className="grid gap-6 text-lg font-medium">
                  <div
                    className="group flex h-10 w-10 shrink-0 items-center justify-center gap-2 rounded-full bg-primary text-lg font-semibold text-primary-foreground md:text-base cursor-pointer"
                    onClick={() => navigate("/")}
                  >
                    <img
                      className="h-3 w-3 transition-all group-hover:scale-110"
                  ...
                  <div className="flex items-center gap-4 px-2.5 text-foreground cursor-pointer">
                    <Package className="h-5 w-5" />
                    Products
                  </div>
                  <div
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead className="p-2 md:table-cell">
                            Price
                          </TableHead>
