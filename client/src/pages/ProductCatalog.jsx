      ...
      <div className="container mx-auto px-4 md:px-6 py-8">
        <div className="grid md:grid-cols-[280px_1fr] gap-8">
          ...
          <div className="grid gap-8">
            ...
            {!data.length && (
              <p className="text-lg font-bold text-center">No items found</p>
            )}
