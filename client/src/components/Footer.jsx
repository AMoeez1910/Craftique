...
<footer class="bg-primary text-secondary">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400">
                      <li class="mb-4">
                          <a href="https://flowbite.com/" class="hover:underline">Funoon</a>
                      </li>
                      <li>
      ...
      <div class="flec items-center width-full text-center">
          <span class="text-sm text-center text-gray-500 text-center ">© 2024 <a href="#" class="hover:underline">Funoon</a>. All Rights Reserved.
          </span>
      </div>
    </div>
</footer>
